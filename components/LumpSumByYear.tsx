              ...
              return (
                <div key={year} className="rounded-lg border p-2 transition-colors"
                  ...
                  <div className="relative">
                    <span className="absolute left-1.5 top-1/2 -translate-y-1/2 text-neutral-400 text-xs">$</span>
                    <input type="text" inputMode="numeric" placeholder="0"
                      ...
                      className="w-full bg-white border border-neutral-200 rounded text-xs text-neutral-900 pl-4 pr-1 py-1.5 focus:outline-none focus:border-blue-500 placeholder-neutral-300"
                    />
                  </div>
                </div>
              );
