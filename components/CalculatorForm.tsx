...
const inp    = "w-full px-3 py-2.5 rounded-lg border border-neutral-200 bg-white text-sm text-neutral-900 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors placeholder-neutral-300";
const inpErr = "w-full px-3 py-2.5 rounded-lg border border-red-300 bg-red-50 text-sm text-neutral-900 focus:outline-none focus:ring-2 focus:ring-red-300 transition-colors";
const lbl    = "text-xs font-medium text-neutral-500 uppercase tracking-wide";
        ...
        <div className="space-y-5">
          ...
          <div className="border-t border-neutral-100 pt-4">
            <button onClick={() => setShowCosts((o) => !o)}
              className="w-full flex items-center justify-between text-xs font-semibold uppercase tracking-widest text-neutral-400 hover:text-neutral-600 transition-colors mb-0"
