      ...
      {open && (
        <div className="px-5 pb-5 border-t border-stone-100 pt-4 space-y-5">
          <p className="text-xs leading-relaxed" style={{ color: "var(--ink-faint)" }}>
            If you break your mortgage before the term ends — to refinance, sell, or switch lenders — your lender will charge a prepayment penalty. For fixed mortgages it's the greater of <strong className="text-stone-600">3-months' interest</strong> or the <strong className="text-stone-600">Interest Rate Differential (IRD)</strong>. Variable mortgages are always 3-months' interest.
          </p>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <span className="text-sm text-stone-700">Variable rate mortgage</span>
            </div>
          </div>
          ...
          <div className="rounded-lg px-3 py-2.5 text-xs leading-relaxed border border-stone-100"
            style={{ background: "var(--cream)", color: "var(--ink-muted)" }}>
            <strong className="text-stone-700">Estimate only.</strong> Actual penalties vary significantly by lender. Some use posted rates vs discounted rates for IRD; some apply different comparison periods. Big bank penalties are typically higher than monoline lenders. Always confirm with your lender before breaking your mortgage.
          </div>
        </div>
      )}
    </div>
