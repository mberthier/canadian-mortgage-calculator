    ...
    <div ref={sectionRef} className="rounded-2xl bg-white border border-neutral-100 overflow-hidden">
      <button onClick={() => setOpen((o) => !o)}
        ...
        <div className="flex items-center gap-2">
          <p className="text-sm font-semibold text-neutral-800">What it costs to walk away early</p>
        ...
        <div className="px-5 pb-5 border-t border-neutral-100 pt-4 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <span className="text-sm text-neutral-700">Variable rate mortgage</span>
            </div>
          </div>
