  ...
  return (
    <svg viewBox="0 0 200 140" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <path d="M106 52 L114 60 L108 66 L116 56 L122 62"
        stroke="#999999" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none"/>

      {/* Crack pieces falling */}
      <path d="M96 56 L92 66" stroke="#dbeafe" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M118 62 L122 70" stroke="#dbeafe" strokeWidth="1.5" strokeLinecap="round"/>
      <rect x="88" y="68" width="8" height="4" rx="1" fill="#dbeafe" transform="rotate(-15 88 68)"/>
      <rect x="118" y="70" width="6" height="3" rx="1" fill="#dbeafe" transform="rotate(10 118 70)"/>

      {/* Your rate label */}
      <rect x="24" y="106" width="52" height="18" rx="4" fill="#eff6ff"/>
