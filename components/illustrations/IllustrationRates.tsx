export default function IllustrationRates() {
  return (
    <svg viewBox="0 0 200 140" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      {/* Grid lines */}
      <line x1="24" y1="110" x2="186" y2="110" stroke="#dce8f2" strokeWidth="1"/>
      <line x1="24" y1="88" x2="186" y2="88" stroke="#dce8f2" strokeWidth="1"/>
      <line x1="24" y1="66" x2="186" y2="66" stroke="#dce8f2" strokeWidth="1"/>
      <line x1="24" y1="44" x2="186" y2="44" stroke="#dce8f2" strokeWidth="1"/>

      {/* Y axis */}
      <line x1="24" y1="22" x2="24" y2="112" stroke="#b5d4f4" strokeWidth="1.5"/>

      {/* Rate labels */}
      <text x="6" y="113" fontSize="8" fill="#7a9ab5" fontFamily="sans-serif">0%</text>
      <text x="6" y="91" fontSize="8" fill="#7a9ab5" fontFamily="sans-serif">2%</text>
      <text x="6" y="69" fontSize="8" fill="#7a9ab5" fontFamily="sans-serif">4%</text>
      <text x="6" y="47" fontSize="8" fill="#7a9ab5" fontFamily="sans-serif">6%</text>
      ...
      <path d="M28 100 L50 90 L70 72 L90 54 L106 50 L120 52 L136 58 L152 66 L170 68 L186 66"
        stroke="#b5d4f4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none"
        strokeDasharray="5 3"/>
      ...
      <rect x="152" y="72" width="44" height="16" rx="3" fill="#e6f1fb" stroke="#b5d4f4" strokeWidth="1"/>
      ...
      <text x="47" y="129" fontSize="8" fill="#7a9ab5" fontFamily="sans-serif">BoC Rate</text>
      <line x1="100" y1="126" x2="116" y2="126" stroke="#b5d4f4" strokeWidth="2"
        strokeDasharray="5 3" strokeLinecap="round"/>
      <text x="119" y="129" fontSize="8" fill="#7a9ab5" fontFamily="sans-serif">5yr Fixed</text>
    </svg>
  );
}
