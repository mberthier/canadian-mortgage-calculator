export default function IllustrationAffordability() {
  return (
    <svg viewBox="0 0 200 140" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <rect x="26" y="74" width="16" height="8" rx="1" fill="#e6f1fb"/>
      ...
      {/* Coin stack */}
      <ellipse cx="166" cy="76" rx="18" ry="5" fill="#b5d4f4"/>
      <rect x="148" y="68" width="36" height="8" rx="4" fill="#b5d4f4" stroke="#0d5a96" strokeWidth="1"/>
      <rect x="148" y="62" width="36" height="8" rx="4" fill="#e6f1fb" stroke="#0d5a96" strokeWidth="1"/>
      <rect x="148" y="56" width="36" height="8" rx="4" fill="#e6f1fb" stroke="#0d5a96" strokeWidth="1"/>
      {/* Pan */}
      <path d="M148 78 Q166 84 184 78" stroke="#0d5a96" strokeWidth="2" fill="none" strokeLinecap="round"/>

      {/* % sign */}
      <text x="90" y="26" fontSize="11" fill="#7a9ab5" fontFamily="sans-serif">39%</text>
    </svg>
  );
}
