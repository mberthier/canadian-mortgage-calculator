...
export function IllustrationFormula() {
  return (
    <svg viewBox="0 0 80 64" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <rect width="80" height="64" rx="12" fill="#e6f1fb"/>
      ...
      <line x1="10" y1="44" x2="70" y2="44" stroke="#b5d4f4" strokeWidth="1"/>
      <text x="10" y="56" fontSize="8" fill="#7a9ab5" fontFamily="sans-serif">Interest Act</text>
    </svg>
  );
}
...
export function IllustrationReceipt() {
  return (
    <svg viewBox="0 0 80 64" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <rect width="80" height="64" rx="12" fill="#e6f1fb"/>
      {/* Receipt shape */}
      <rect x="18" y="8" width="44" height="48" rx="3" fill="white" stroke="#b5d4f4" strokeWidth="1.5"/>
      <line x1="24" y1="20" x2="56" y2="20" stroke="#b5d4f4" strokeWidth="1"/>
      <line x1="24" y1="28" x2="56" y2="28" stroke="#b5d4f4" strokeWidth="1"/>
      <line x1="24" y1="36" x2="56" y2="36" stroke="#b5d4f4" strokeWidth="1"/>
...
export function IllustrationCalendar() {
  return (
    <svg viewBox="0 0 80 64" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <rect width="80" height="64" rx="12" fill="#e6f1fb"/>
      <rect x="12" y="14" width="56" height="42" rx="4" fill="white" stroke="#b5d4f4" strokeWidth="1.5"/>
      ...
      {/* Grid dots for days */}
      {[0,1,2,3,4,5,6].map(c => (
        <circle key={c} cx={20 + c*9} cy={38} r={2} fill={c === 4 ? "#1068A8" : "#b5d4f4"}/>
      ))}
      {[0,1,2,3].map(c => (
        <circle key={c} cx={20 + c*9} cy={48} r={2} fill="#b5d4f4"/>
      ))}
