    ...
    <div className="border-t border-neutral-100 pt-5">
      <button onClick={() => setOpen((o) => !o)}
        ...
        <div className="flex items-center gap-2">
          {ltt.net > 0 && <span className="normal-case font-normal text-neutral-500">{formatCurrency(ltt.net, 0)}</span>}
      ...
      {open && (
        <div className="mt-4 space-y-3">
          ...
          <div className="rounded-lg border border-neutral-100 p-3 space-y-2 text-sm" style={{ background: "#f8f8f8" }}>
            ...
            <div className="flex justify-between font-semibold border-t border-neutral-200 pt-2 text-neutral-900">
            ...
            {ltt.net === 0 && ["SK","NL","NT","NU","YT"].includes(inputs.province) && (
              <p className="text-xs text-neutral-400">No provincial land transfer tax in this province.</p>
            )}
          </div>
        </div>
      )}
