...
export default function AffordabilityClient() {
  ...
  const inpR = "w-full px-3 pr-8 py-2.5 rounded-lg border border-stone-200 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-green-700/20 focus:border-green-700 transition-colors";
